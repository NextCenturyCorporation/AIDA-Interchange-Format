...
AIDA_PROGRAM_ONTOLOGY = ClosedNamespace(
    ...
    terms=["Person", "Organization", "Location", "Facility", "GeopoliticalEntity", "String",
           ...
           "transaction.transfer-ownership", "children", "parents", "other_family",
...
AIDA_PROGRAM_ONTOLOGY_LUT = {"PER": AIDA_PROGRAM_ONTOLOGY.Person, "ORG": AIDA_PROGRAM_ONTOLOGY.Organization,
