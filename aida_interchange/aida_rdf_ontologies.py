...
AIDA_DOMAIN_COMMON = ClosedNamespace(
    uri=URIRef("http://darpa.mil/ontologies/AidaDomainOntologiesCommon#"),
    terms=["EntityType", "EventType", "EventArgumentType", "RelationType"]
)
